...
We will link (via symbolic link) to a secure data folder called `"secure_data"`.
...
The metadata is stored as a quoted named list: one element in the list per template file.
